...
class LunarCurrency{
	 ...
	 * @return int|number
	 */
	public function getLunarCurrencyMultiplier( $currency_iso_code ) {
		$currency = $this->getLunarCurrency( $currency_iso_code );
		...
		public function getLunarCurrency( $currency_iso_code ) {
	$currencies = array(
		'AED' =>
			array(
				'code'     => 'AED',
